...
//Object Values
GLfloat object_radius = 0.3f; //object radius
...
GLfloat material_Spec[] = {0.0, 0.3, 0.3, 1.0};
...
void display(){
    ...
    //if the ball exceeds the edges, it will rebound and move in the opposite direction
